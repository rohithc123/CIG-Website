...
const AdminTeam = () => {
  ...
  const handleUpload = async (e) => {
    ...
    const { file, name, phone,vertical, email,Linkedin } = formData;
    ...
    uploadData.append('vertical', vertical);
    ...
    <>
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
        ...
        <form onSubmit={handleUpload} className="bg-white p-6 rounded shadow-md w-full max-w-md">
          {['name', 'phone', 'email','Linkedin','vertical'].map((field) => (
            <input
              key={field}
              type="text"
              name={field}
            ...
            TeamData.map((data, index) => (
              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="text-[#ABABAB] font-medium text-base">{data.vertical}</div>
